...
╔══════════════════════════════════════════╗
║ Creator  : MR RAKIB            ║
║ Github   : https://t.me/AMRRAKIB-404║
║
║ Version  : 500.0                         ║
║ FILENAME : MR RAKIB          ║
╚══════════════════════════════════════════╝
...
def passwrd():
	...
	krek = '[•] OK RESULTS SAVED IN : INTERNAL MEMORY/TOUFIQ-DATA/OK/%s\n[•] CP RESULTS SAVED IN : INTERNAL MEMORY/TOUFIQ-DATA/CP/%s\nON OF AIRPLANE MODE EVERY 500 ID'%(okc,cpc)
...
if __name__=='__main__':
	...
	try:os.mkdir('/sdcard/RAKIB-DATA/CP')
	except:pass
	try:os.mkdir('/sdcard/RAKIB-DATA/OK')
	except:pass
	try:os.mkdir('/sdcard/RAKIB-DATA/DUMP')
	except:pass
	login()